...
def apply_theme(company=None):
    ...
    [data-testid="stMetric"]{{background:linear-gradient(145deg,#FFFFFF,#FBFCFD);border:1px solid var(--line);border-radius:16px;padding:18px 20px;box-shadow:0 10px 28px rgba(16,24,40,.055);min-width:0;overflow:visible}}
    [data-testid="stMetricLabel"]{{color:#667085;font-weight:650}}
    [data-testid="stMetricValue"],[data-testid="stMetricValue"]>div{{color:#101828!important;font-weight:760!important;letter-spacing:-.02em!important;font-size:1.3rem!important;line-height:1.16!important;white-space:normal!important;max-width:100%!important;overflow:visible!important;text-overflow:clip!important;overflow-wrap:anywhere!important}}
    ...
    .stTextInput [data-baseweb="input"],.stNumberInput [data-baseweb="input"],.stDateInput [data-baseweb="input"],.stTimeInput [data-baseweb="input"]{{min-height:3rem!important;background:#F8FAFC!important;border:1px solid #C9D0DA!important;border-radius:11px!important;box-shadow:inset 0 1px 2px rgba(16,24,40,.035)!important;overflow:hidden!important}}
    .stTextInput [data-baseweb="input"] input,.stNumberInput [data-baseweb="input"] input,.stDateInput [data-baseweb="input"] input,.stTimeInput [data-baseweb="input"] input{{border:0!important;border-radius:0!important;box-shadow:none!important;background:transparent!important}}
    .stNumberInput [data-baseweb="input"] button{{height:100%!important;min-width:2.75rem!important;background:#F1F4F8!important;border-left:1px solid #D7DCE4!important;color:#344054!important}}
    ...
    [data-baseweb="select"],[data-testid="stSelectbox"] [data-baseweb="select"],[data-testid="stMultiSelect"] [data-baseweb="select"]{{min-height:3rem!important;background:#F8FAFC!important;border:1px solid #C9D0DA!important;border-radius:11px!important;box-shadow:inset 0 1px 2px rgba(16,24,40,.035)!important;overflow:visible!important}}
    [data-baseweb="select"]>div,[data-testid="stSelectbox"] [data-baseweb="select"]>div,[data-testid="stMultiSelect"] [data-baseweb="select"]>div{{min-height:2.9rem!important;background:#F8FAFC!important;border:1px solid #C9D0DA!important;border-radius:10px!important;box-shadow:inset 0 1px 2px rgba(16,24,40,.035)!important}}
    div[data-testid="stMultiSelect"]>div>div,div[data-testid="stSelectbox"]>div>div{{border-color:#C9D0DA!important;border-radius:11px!important}}
    [data-baseweb="select"]:focus-within,[data-testid="stSelectbox"] [data-baseweb="select"]:focus-within,[data-testid="stMultiSelect"] [data-baseweb="select"]:focus-within{{background:#FFFFFF!important;border-color:{primary}!important;box-shadow:0 0 0 3px {primary}14!important}}
    [data-testid="stMultiSelect"] [data-baseweb="tag"]{{background:{primary}12!important;border:1px solid {primary}28!important;border-radius:999px!important;color:{primary}!important}}
    [data-testid="stFileUploaderDropzone"]{{background:#F8FAFC!important;border:1px dashed #B8C1CE!important;border-radius:13px!important}}
