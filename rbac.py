...
ALL_PAGES={"Command Centre","Fuel Operations","Fleet Inventory","Inventory Control","Transaction Control","Depots & Storage","Storage Operations","Supplier Procurement","Inventory Forecasting","Financial Valuation","Truck Ledger","Integration Inbox","Approvals","Notifications","Report Centre","Audit Centre","Configuration","User Access"}
PAGE_PERMISSIONS={
 ...
 "PROCUREMENT_USER":{"Command Centre","Supplier Procurement","Storage Operations","Inventory Forecasting","Financial Valuation","Notifications","Report Centre"},
 ...
 "AUDITOR":{"Command Centre","Fleet Inventory","Inventory Control","Transaction Control","Depots & Storage","Supplier Procurement","Inventory Forecasting","Financial Valuation","Truck Ledger","Notifications","Report Centre","Audit Centre"},
 "VIEWER":{"Command Centre","Fleet Inventory","Depots & Storage","Inventory Forecasting","Financial Valuation","Truck Ledger","Notifications","Report Centre"},
