...
PAGE_PERMISSIONS={
 ...
 "PROCUREMENT_USER":{"Command Centre","Supplier Procurement","Storage Operations","Inventory Forecasting","Financial Valuation","Evidence Centre","Notifications","Report Centre"},
 "APPROVER":{"Command Centre","Inventory Control","Transaction Control","Approvals","Supplier Procurement","Month-End Closing","Evidence Centre","Notifications","Report Centre","Audit Centre"},
 "AUDITOR":{"Command Centre","Fleet Inventory","Inventory Control","Transaction Control","Depots & Storage","Supplier Procurement","Inventory Forecasting","Financial Valuation","Month-End Closing","Evidence Centre","Truck Ledger","Notifications","Report Centre","Audit Centre"},
