...
PAGE_PERMISSIONS={
 ...
 "APPROVER":{"Command Centre","Inventory Control","Transaction Control","Approvals","Supplier Procurement","Month-End Closing","Notifications","Report Centre","Audit Centre"},
 "AUDITOR":{"Command Centre","Fleet Inventory","Inventory Control","Transaction Control","Depots & Storage","Supplier Procurement","Inventory Forecasting","Financial Valuation","Month-End Closing","Truck Ledger","Notifications","Report Centre","Audit Centre"},
 "VIEWER":{"Command Centre","Fleet Inventory","Depots & Storage","Inventory Forecasting","Financial Valuation","Month-End Closing","Truck Ledger","Notifications","Report Centre"},
