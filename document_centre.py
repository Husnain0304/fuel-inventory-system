...
LINK_TYPES = {
    ...
    "Tank Count (TC)": ("TANK_CYCLE_COUNT", "tank_cycle_counts"),
    "Tank Calibration (CAL)": ("TANK_CALIBRATION", "tank_calibrations"),
    "Inventory Incident (INC)": ("INVENTORY_INCIDENT", "inventory_incidents"),
    "Stock in Transit (IT)": ("INVENTORY_TRANSFER", "inventory_transfers"),
    "Receipt Invoice Match (INV)": ("RECEIPT_INVOICE", "supplier_receipt_invoices"),
    "Depot": ("DEPOT", "depots"),
