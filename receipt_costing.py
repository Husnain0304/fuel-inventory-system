...
def _xlsx(data,company):
 ...
 for column_index,col in enumerate(ws.columns,1): ws.column_dimensions[get_column_letter(column_index)].width=min(max(14,max(len(str(x.value or '')) for x in col)+2),30)
